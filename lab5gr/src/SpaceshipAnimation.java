...
public class SpaceshipAnimation extends KeyAdapter implements ActionListener {

    private static final float DELTA_DISTANCE = 0.02f;
    private static final float DELTA_ANGLE = 0.05f;

    private final Spaceship spaceship;
    private final TransformGroup spaceshipTransformGroup;
    ...
    public SpaceshipAnimation(Spaceship spaceship) {
        this.spaceship = spaceship;

        this.spaceshipTransformGroup = spaceship.getSpaceshipTransformGroup();
        this.spaceshipTransformGroup.getTransform(this.transform3D);
    ...
    private void Move() {
        ...
        spaceshipTransformGroup.setTransform(transform3D);
    }
    ...
    public void keyPressed(KeyEvent ev) {
        switch (ev.getKeyCode()) {
            case 32: // Space
                spaceship.generateShot(xLoc, yLoc + 0.05f, 1);
                break;
            case 87: // W
                isPressedW = true;
                break;
